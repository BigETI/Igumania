...
namespace AmplifyShaderEditor
{
	...
	public class UIUtils
	{
		...
		public static RenderTexture DummyPreviewRT;
		...
		public static void Destroy()
		{
			...
			if( DummyPreviewRT != null )
				DummyPreviewRT.Release();

			ScriptableObject.DestroyImmediate( DummyPreviewRT );
		...
		public static void InitMainSkin()
		{
			...
			if( DummyPreviewRT == null )
			{
				DummyPreviewRT = new RenderTexture( 128 , 128 , 0 , RenderTextureFormat.ARGB32 );
				RenderTexture temp = RenderTexture.active;
				RenderTexture.active = DummyPreviewRT;
				Graphics.Blit( Texture2D.blackTexture , DummyPreviewRT );
